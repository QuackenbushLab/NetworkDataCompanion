---
title: "Introduction to the NetSciDataCompanion"
...
# Introduction to the NetSciDataCompanion
...
The **NetSciDataCompanion** supports preprocessing of **TCGA** bulk RNA-seq and DNA-methylation data.
...
## Generate NetSciDataCompanion instance
obj <- CreateNetSciDataCompanionObject(project_name = "LUAD")
...
idcs_tumor_normal <- obj$filterSampleType(colnames(exp_count_mat), c("Solid Tissue Normal", "Primary Tumor"), rds_sample_info)
idcs_tumor <- idcs_tumor_normal$index[idcs_tumor_normal$type == "Primary Tumor"]
idcs_normal <- idcs_tumor_normal$index[idcs_tumor_normal$type == "Solid Tissue Normal"]
...
episcores <- obj$estimateCellCountsEpiSCORE(methylation_betas = betas, tissue = 'Lung')
print(episcores)
```
