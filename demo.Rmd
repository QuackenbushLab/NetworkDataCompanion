---
title: "NetSciDataCompanion Demo"
author: "Kate"
date: '2022-09-22'
output: 
  rmdformats::robobook:
...
To create a NetSciDataCompanion object ("Companion object"), you need to specify a project name and provide a path to a file of clinical data output by the Nextflow workflow.
...
Next, we use the `CreateNetSciDataCompanionObject` function to create a Companion object:

```{R}
obj = CreateNetSciDataCompanionObject(clinical_patient_file = patient_data,  project_name = project_name)
```
